...
class ListadoVentas extends React.Component {
    ...
    filtro = (venta) => {
        ...
        if (value) {
            ...
            return (venta.id && venta.id.toString().includes(value))
    ...
    peticionPut=()=>{
        alert("hola")
        firebase.child(`ventas/${this.state.id}`).set(
             this.state.form,
             error=>{
                            ...
                            <div className="col-md-6">
                                <form id="buscar-form" onSubmit={this.actualizarFiltro}>
                                    <div className="form-group">
                                        ...
                                        <input type="text" id="id-venta" className="form-control"
                                               placeholder="Ingrese ID de la venta o nombre del cliente" autoFocus
                        ...
                        {this.state.ListaVentas.filter(this.filtro).map((venta) => (
                                <tr key={venta.Id}>
                                    ...
                                    <td>
                                        ...
                                        <Button color="danger" onClick={() => this.eliminar(venta)}>
                                            Eliminar
                                        </Button>
                                    </td>
                                </tr>
